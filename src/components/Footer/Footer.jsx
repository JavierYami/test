    ...
    return (
        ...
        <div>
            ...
            <footer className='footerStyle'>
                <p></p>
                <p className='footerText'>SolLivre Brasil | Rua 123, Nº 45 - Sala 201 | Edifício Solar | (21) 9078-3459 | info@solbr.com.br</p>
                <a className='footerText' style={{textDecoration:'underline'}}> <b>Aviso de privacidade</b></a>
            </footer>
        </div>
